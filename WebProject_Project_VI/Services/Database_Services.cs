...
namespace WebProject_Project_VI.Services
{
    public class Database_Services
    {
        ...
        public Database_Services? Set_Up_Database_Services(ILogger<HomeController>? logger, string? SessionID)
        {
            ...
            Account_Table_Services _account_Table_Services = new Account_Table_Services();
            Post_Table_Services _post_Table_Services = new Post_Table_Services();
            _account_Table_Services.Set_Up_Account_Table_Services(SessionID, configuration);
            _post_Table_Services.Set_Up_Post_Table_Services(SessionID, configuration);
        ...
        public async Task<List<IData>?> Read_All_Data_By_Table_Name_Async(string? table_name,string? username_account_authorized, string? password_account_authorized)
        {
            ...
            Account_Table_Services _account_Table_Services = new Account_Table_Services();
            Post_Table_Services _post_Table_Services = new Post_Table_Services();
            _account_Table_Services.Set_Up_Account_Table_Services(SesionID, configuration);
             _post_Table_Services.Set_Up_Post_Table_Services(SesionID, configuration);
            ...
            }else if(table_name == Post_Table_Name)
            {
        ...
        public async Task<bool> Update_Public_Mode_Post_Data_By_Title_Async(string? title, bool? Is_Public)
        {
            ...
            bool is_Account_Updated = await _post_Table_Services.Update_Post_Data_String_By_Title_Async(null, title, propertyUpdated, Is_Public.ToString(), "bool");
            if (is_Account_Updated == false)
            {
                if (_logger != null)
        ...
        //                          Date : DateTime
         */
        public async Task<bool> Update_Property_Data_Post_Data_By_Title_And_Property_Async(string? title,string? propertyUpdated, string? new_Values, string? type_Property)
        {
            IConfiguration configuration = new ConfigurationBuilder()
            .AddJsonFile("appsettings.json")
            .Build();
        ...
        public async Task<bool> Update_Public_Mode_Post_Data_By_Post_ID_Async(int? Post_ID, bool? Is_Public)
        {
            ...
            string propertyUpdated = "Is_Public";
            bool is_Account_Updated = await _post_Table_Services.Update_Post_Data_String_By_Title_Async(Post_ID , null, propertyUpdated, Is_Public.ToString(), "bool");
            if (is_Account_Updated == false)
            {
                if (_logger != null)
                    _logger.LogError("Failed to update Post data by Post_ID from Post Table!");
        ...
        //                          Date : DateTime
         */
        public async Task<bool> Update_Property_Data_Post_Data_By_Post_ID_And_Property_Async(int? Post_ID, string? propertyUpdated, string? new_Values, string? type_Property)
        {
             IConfiguration configuration = new ConfigurationBuilder()
            .AddJsonFile("appsettings.json")
            .Build();
